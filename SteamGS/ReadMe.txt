========================================================================
    DYNAMIC LINK LIBRARY: SteamGS-Projektübersicht
========================================================================

Diese SteamGS-DLL wurde vom Anwendungs-Assistenten für 
Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre SteamGS-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "SteamGS.pch und eine 
